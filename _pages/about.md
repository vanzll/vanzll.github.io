...
My research is driven by genuinely understanding (both theoretically and intuitively) the rationale, spirit and failure modes of ML algorithms and methods, rather than merely improving the benchmark scores. I am recently working on fundamental side of Multi-modal generation, RL Post-training and Physical AI. Particularly:
...
I always enjoy working with talents, academic collaboration/industrial opportunities/VCs are welcomed to reach out via email!
