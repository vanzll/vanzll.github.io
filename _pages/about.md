...
- *2024.10*  &nbsp;🎉🎉 My co-first-author paper *Hierarchical Spatial-Temporal Graph-Enhanced Model for Map-Matching* is accepted by *Australasian Database Conference 2025*, to be hold at Tokyo on 16 Dec (oral presentation), and published at [*Springer Nature*](https://link.springer.com/chapter/10.1007/978-981-96-1242-0_4).
